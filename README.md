...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/holidays-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `holidays` can be installed with:

```
conda install holidays
```

It is possible to list all of the versions of `holidays` available on your platform with:
